...
import fermi_curvature_and_tags as curvature_tags_and_blocks
...
def init_fermi_net_params(key, atoms, spins, envelope_type, bias_orbitals, use_last_layer, hf_solution, eps = 0.01, full_det = True, 
                          hidden_dims = ((256, 32), (256, 32), (256, 32)), determinants = 16, after_determinants = 1):
  """
